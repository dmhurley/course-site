...
class Answer
{
     ...
     * Set testTaker
     *
     * @param \Bio\NewExamBundle\Entity\TestTaker $testTaker
     * @return Answer
     */
    public function setTestTaker(\Bio\NewExamBundle\Entity\TestTaker $testTaker = null)
    {
     ...
     * Set question
     *
     * @param \Bio\NewExamBundle\Entity\Question $question
     * @return Answer
     */
    public function setQuestion(\Bio\NewExamBundle\Entity\Question $question = null)
    {
     ...
     * Get question
     *
     * @return \Bio\NewExamBundle\Entity\Question 
     */
